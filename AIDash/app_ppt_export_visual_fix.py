...
async def export_pptx():
    ...
    # Heatmap slide exported as a high-resolution image to avoid native table rendering issues in PowerPoint/Render
    heatmap_png = BASE_DIR / "static" / "ppt_heatmap.png"
    make_heatmap_slide_image(cases, heatmap_png)
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    # Full-slide image: the image includes title, table, colours and legend
